...
const cardContents = [
  {
    ...
    content:
      <>
        One of the most important principles that guide our development.
        <br />
        We are focused on take the best decision for the product and help our clients turn their business more profitable. We do not fall in love with the produced code or IT solution, we love the products that we build together.
      </>
  },
  {
    key: 3,
